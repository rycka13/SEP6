...
describe('app > user-list > top-list > top-list.component.spec.ts', () => {
  let spectator: Spectator<TopListComponent>;
  let createComponent: SpectatorFactory<TopListComponent> = createComponentFactory({
